# project-rag-chat Specification

## Purpose
Define project-scoped RAG chat so authenticated owners can ask questions against only their own project knowledge base, receive streamed evidence-grounded answers, and keep owner-scoped session history with citations.
