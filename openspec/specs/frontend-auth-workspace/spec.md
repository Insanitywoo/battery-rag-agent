...
### Requirement: Frontend MAY provide only bounded experiment-analysis workspace extensions in this capability
...
- **WHEN** an authenticated owner uses the project workspace after this capability is introduced
