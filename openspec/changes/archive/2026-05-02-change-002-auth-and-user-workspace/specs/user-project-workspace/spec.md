...
The project detail capability introduced in this change SHALL be limited to owner-scoped project metadata and workspace identification, and MUST NOT introduce document upload, knowledge base, RAG, Agent, or Skills business workflows.

#### Scenario: Project detail remains within auth-and-workspace scope
- **WHEN** project detail behavior is reviewed in this change
- **THEN** the returned or displayed detail scope SHALL remain limited to project-level metadata and workspace structure for future expansion
